...
export default function AddStudent({ onClose, onSuccess }) {
 ...
 const submit = async () => {
  ...
  setLoading(true);
  try {
   await axios.post("http://localhost:5050/api/admin-manage/students/add", form);
   alert("Student Added Successfully ✅");
   if (onSuccess) onSuccess();
   onClose();
  } catch (err) {
   console.log("Error:", err.response?.data || err.message);
   const errorMsg = err.response?.data?.message || err.response?.data?.error?.message || "Failed to add student";
     ...
     <div className="form-section">
      ...
      <div className="modal-grid">
       ...
       <div className="form-group">
        ...
        />
        {errors.roll && <span className="error-text">{errors.roll}</span>}
       </div>
       ...
       <div className="form-group">
        ...
        <input 
         ...
         onChange={handleChange}
         className={errors.admission_year ? "error" : ""}
        />
      ...
      <div className="modal-grid">
       ...
       <div className="form-group">
        ...
        <input 
         ...
         onChange={handleChange}
         className={errors.father_mobile ? "error" : ""}
        />
        {errors.father_mobile && <span className="error-text">{errors.father_mobile}</span>}
       </div>
